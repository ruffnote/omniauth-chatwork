...
Gem::Specification.new do |spec|
  ...
  spec.summary       = %q{Official OmniAuth strategy for Chatwork.}
  spec.description   = %q{Official OmniAuth strategy for Chatwork.}
  spec.homepage      = "https://github.com/ruffnote/omniauth-chatwork"
  spec.license       = "MIT"
